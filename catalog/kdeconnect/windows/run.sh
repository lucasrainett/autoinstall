...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'KDE Connect' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'KDE Connect*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: KDE Connect'; exit 1 }
