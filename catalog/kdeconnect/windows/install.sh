...
if winget list --id KDE.KDEConnect -e --accept-source-agreements 2>/dev/null | grep -qi "KDE.KDEConnect"; then
  echo "KDE.KDEConnect is already installed; nothing to do."
  exit 0
fi
