...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'Handy' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'Handy*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: Handy'; exit 1 }
