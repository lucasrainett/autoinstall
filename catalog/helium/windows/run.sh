...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'Helium' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'Helium*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: Helium'; exit 1 }
