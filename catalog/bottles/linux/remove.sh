...
if flatpak info --user com.usebottles.bottles &>/dev/null; then
  flatpak uninstall --user com.usebottles.bottles -y
elif flatpak info --system com.usebottles.bottles &>/dev/null; then
  flatpak uninstall --system com.usebottles.bottles -y
fi
