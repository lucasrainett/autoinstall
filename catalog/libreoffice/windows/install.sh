...
if winget list --id TheDocumentFoundation.LibreOffice -e --accept-source-agreements 2>/dev/null | grep -qi "TheDocumentFoundation.LibreOffice"; then
  echo "TheDocumentFoundation.LibreOffice is already installed; nothing to do."
  exit 0
fi
