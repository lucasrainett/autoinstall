...
if winget upgrade --id TheDocumentFoundation.LibreOffice -e --accept-source-agreements --disable-interactivity 2>/dev/null | grep -qi "TheDocumentFoundation.LibreOffice"; then
  exit 2
fi
exit 0
