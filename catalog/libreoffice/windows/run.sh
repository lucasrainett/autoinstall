...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'LibreOffice' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'LibreOffice*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: LibreOffice'; exit 1 }
