...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'GIMP' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'GIMP*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: GIMP'; exit 1 }
