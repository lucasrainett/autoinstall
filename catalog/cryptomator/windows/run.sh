...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'Cryptomator' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'Cryptomator*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: Cryptomator'; exit 1 }
