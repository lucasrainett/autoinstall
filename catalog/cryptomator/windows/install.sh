...
if winget list --id Cryptomator.Cryptomator -e --accept-source-agreements 2>/dev/null | grep -qi "Cryptomator.Cryptomator"; then
  echo "Cryptomator.Cryptomator is already installed; nothing to do."
  exit 0
fi
