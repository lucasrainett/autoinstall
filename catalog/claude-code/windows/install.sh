...
if winget list --id Anthropic.ClaudeCode -e --accept-source-agreements 2>/dev/null | grep -qi "Anthropic.ClaudeCode"; then
  echo "Anthropic.ClaudeCode is already installed; nothing to do."
  exit 0
fi
