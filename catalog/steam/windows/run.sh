...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'Steam' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'Steam*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: Steam'; exit 1 }
