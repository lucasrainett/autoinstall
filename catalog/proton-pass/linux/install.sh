...
# Proton doesn't publish an apt repo for Pass, only a versionless "always latest" .deb download URL.
...
curl -fsSL -o "$TMP_DEB" "https://proton.me/download/PassDesktop/linux/x64/ProtonPass.deb"
