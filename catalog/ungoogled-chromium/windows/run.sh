...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'Ungoogled Chromium' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'Ungoogled Chromium*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: Ungoogled Chromium'; exit 1 }
