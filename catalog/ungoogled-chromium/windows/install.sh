...
if winget list --id eloston.ungoogled-chromium -e --accept-source-agreements 2>/dev/null | grep -qi "eloston.ungoogled-chromium"; then
  echo "eloston.ungoogled-chromium is already installed; nothing to do."
  exit 0
fi
