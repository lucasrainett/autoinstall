...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'Beeper' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'Beeper*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: Beeper'; exit 1 }
