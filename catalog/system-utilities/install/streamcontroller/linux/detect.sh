...
flatpak list --columns=application 2>/dev/null | grep -qx "com.core447.StreamController" || exit 1
...
installed=$(flatpak info "$scope" --show-commit com.core447.StreamController 2>/dev/null) || exit 0
