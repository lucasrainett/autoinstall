...
if flatpak info --user org.angryip.ipscan &>/dev/null; then
  flatpak uninstall --user org.angryip.ipscan -y
elif flatpak info --system org.angryip.ipscan &>/dev/null; then
  flatpak uninstall --system org.angryip.ipscan -y
fi
