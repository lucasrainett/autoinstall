...
if flatpak info --user org.videolan.VLC &>/dev/null; then
  flatpak uninstall --user org.videolan.VLC -y
elif flatpak info --system org.videolan.VLC &>/dev/null; then
  flatpak uninstall --system org.videolan.VLC -y
fi
