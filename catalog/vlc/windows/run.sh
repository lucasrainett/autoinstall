...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'VLC' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'VLC*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: VLC'; exit 1 }
