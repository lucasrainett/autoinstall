...
if winget list --id aristocratos.btop4win -e --accept-source-agreements 2>/dev/null | grep -qi "aristocratos.btop4win"; then
  echo "aristocratos.btop4win is already installed; nothing to do."
  exit 0
fi
