...
if winget list --id SoftFever.OrcaSlicer -e --accept-source-agreements 2>/dev/null | grep -qi "SoftFever.OrcaSlicer"; then
  echo "SoftFever.OrcaSlicer is already installed; nothing to do."
  exit 0
fi
