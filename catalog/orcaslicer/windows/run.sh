...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'OrcaSlicer' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'OrcaSlicer*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: OrcaSlicer'; exit 1 }
