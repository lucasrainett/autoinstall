...
if flatpak info --user com.valvesoftware.Steam &>/dev/null; then
  flatpak uninstall --user com.valvesoftware.Steam -y
elif flatpak info --system com.valvesoftware.Steam &>/dev/null; then
  flatpak uninstall --system com.valvesoftware.Steam -y
fi
