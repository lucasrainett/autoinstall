...
if winget list --id Microsoft.OneDrive -e --accept-source-agreements 2>/dev/null | grep -qi "Microsoft.OneDrive"; then
  echo "Microsoft.OneDrive is already installed; nothing to do."
  exit 0
fi
