...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'Claude Desktop' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'Claude Desktop*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: Claude Desktop'; exit 1 }
