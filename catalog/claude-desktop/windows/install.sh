...
if winget list --id Anthropic.Claude -e --accept-source-agreements 2>/dev/null | grep -qi "Anthropic.Claude"; then
  echo "Anthropic.Claude is already installed; nothing to do."
  exit 0
fi
