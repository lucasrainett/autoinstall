...
if flatpak info --user org.freeplane.App &>/dev/null; then
  flatpak uninstall --user org.freeplane.App -y
elif flatpak info --system org.freeplane.App &>/dev/null; then
  flatpak uninstall --system org.freeplane.App -y
fi
