...
if winget list --id Freeplane.Freeplane -e --accept-source-agreements 2>/dev/null | grep -qi "Freeplane.Freeplane"; then
  echo "Freeplane.Freeplane is already installed; nothing to do."
  exit 0
fi
