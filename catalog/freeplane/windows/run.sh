...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'Freeplane' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'Freeplane*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: Freeplane'; exit 1 }
