...
if winget list --id LibreWolf.LibreWolf -e --accept-source-agreements 2>/dev/null | grep -qi "LibreWolf.LibreWolf"; then
  echo "LibreWolf.LibreWolf is already installed; nothing to do."
  exit 0
fi
