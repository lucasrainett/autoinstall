...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'LibreWolf' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'LibreWolf*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: LibreWolf'; exit 1 }
