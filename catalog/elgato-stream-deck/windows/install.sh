...
if winget list --id Elgato.StreamDeck -e --accept-source-agreements 2>/dev/null | grep -qi "Elgato.StreamDeck"; then
  echo "Elgato.StreamDeck is already installed; nothing to do."
  exit 0
fi
