...
if winget list --id HeroicGamesLauncher.HeroicGamesLauncher -e --accept-source-agreements 2>/dev/null | grep -qi "HeroicGamesLauncher.HeroicGamesLauncher"; then
  echo "HeroicGamesLauncher.HeroicGamesLauncher is already installed; nothing to do."
  exit 0
fi
