...
if winget upgrade --id HeroicGamesLauncher.HeroicGamesLauncher -e --accept-source-agreements 2>/dev/null | grep -qi "HeroicGamesLauncher.HeroicGamesLauncher"; then
  exit 2
fi
exit 0
