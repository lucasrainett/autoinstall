...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'Brave' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'Brave*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: Brave'; exit 1 }
