...
if flatpak info --user com.mojang.Minecraft &>/dev/null; then
  flatpak uninstall --user com.mojang.Minecraft -y
elif flatpak info --system com.mojang.Minecraft &>/dev/null; then
  flatpak uninstall --system com.mojang.Minecraft -y
fi
