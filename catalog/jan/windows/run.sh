...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'Jan' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'Jan*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: Jan'; exit 1 }
