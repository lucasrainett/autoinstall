...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'Podman Desktop' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'Podman Desktop*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: Podman Desktop'; exit 1 }
