...
if winget list --id RedHat.Podman-Desktop -e --accept-source-agreements 2>/dev/null | grep -qi "RedHat.Podman-Desktop"; then
  echo "RedHat.Podman-Desktop is already installed; nothing to do."
  exit 0
fi
