...
if winget list --id Python.Python.3 -e --accept-source-agreements 2>/dev/null | grep -qi "Python.Python.3"; then
  echo "Python.Python.3 is already installed; nothing to do."
  exit 0
fi
