...
if winget list --id HandBrake.HandBrake -e --accept-source-agreements 2>/dev/null | grep -qi "HandBrake.HandBrake"; then
  echo "HandBrake.HandBrake is already installed; nothing to do."
  exit 0
fi
