...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'HandBrake' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'HandBrake*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: HandBrake'; exit 1 }
