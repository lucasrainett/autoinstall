...
if winget list --id Docker.DockerDesktop -e --accept-source-agreements 2>/dev/null | grep -qi "Docker.DockerDesktop"; then
  echo "Docker.DockerDesktop is already installed; nothing to do."
  exit 0
fi
