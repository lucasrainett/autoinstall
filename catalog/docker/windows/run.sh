...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'Docker' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'Docker*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: Docker'; exit 1 }
