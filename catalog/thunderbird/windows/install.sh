...
if winget list --id Mozilla.Thunderbird -e --accept-source-agreements 2>/dev/null | grep -qi "Mozilla.Thunderbird"; then
  echo "Mozilla.Thunderbird is already installed; nothing to do."
  exit 0
fi
