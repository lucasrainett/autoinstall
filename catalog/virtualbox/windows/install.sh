...
if winget list --id Oracle.VirtualBox -e --accept-source-agreements 2>/dev/null | grep -qi "Oracle.VirtualBox"; then
  echo "Oracle.VirtualBox is already installed; nothing to do."
  exit 0
fi
