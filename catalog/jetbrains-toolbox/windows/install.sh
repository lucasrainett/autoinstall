...
if winget list --id JetBrains.Toolbox -e --accept-source-agreements 2>/dev/null | grep -qi "JetBrains.Toolbox"; then
  echo "JetBrains.Toolbox is already installed; nothing to do."
  exit 0
fi
