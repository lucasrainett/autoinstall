...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'JetBrains Toolbox' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'JetBrains Toolbox*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: JetBrains Toolbox'; exit 1 }
