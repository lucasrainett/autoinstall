...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'VSCodium' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'VSCodium*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: VSCodium'; exit 1 }
