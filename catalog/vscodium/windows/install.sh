...
if winget list --id VSCodium.VSCodium -e --accept-source-agreements 2>/dev/null | grep -qi "VSCodium.VSCodium"; then
  echo "VSCodium.VSCodium is already installed; nothing to do."
  exit 0
fi
