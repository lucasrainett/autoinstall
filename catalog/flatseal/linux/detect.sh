...
flatpak list --columns=application 2>/dev/null | grep -qx "com.github.tchx84.Flatseal" || exit 1
...
installed=$(flatpak info "$scope" --show-commit com.github.tchx84.Flatseal 2>/dev/null) || exit 0
