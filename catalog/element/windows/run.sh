...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'Element' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'Element*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: Element'; exit 1 }
