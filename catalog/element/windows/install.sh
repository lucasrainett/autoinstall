...
if winget list --id Element.Element -e --accept-source-agreements 2>/dev/null | grep -qi "Element.Element"; then
  echo "Element.Element is already installed; nothing to do."
  exit 0
fi
