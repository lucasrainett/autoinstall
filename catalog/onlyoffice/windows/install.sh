...
if winget list --id ONLYOFFICE.DesktopEditors -e --accept-source-agreements 2>/dev/null | grep -qi "ONLYOFFICE.DesktopEditors"; then
  echo "ONLYOFFICE.DesktopEditors is already installed; nothing to do."
  exit 0
fi
