...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'ONLYOFFICE Desktop Editors' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'ONLYOFFICE Desktop Editors*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: ONLYOFFICE Desktop Editors'; exit 1 }
