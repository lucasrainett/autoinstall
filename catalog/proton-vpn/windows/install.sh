...
if winget list --id Proton.ProtonVPN -e --accept-source-agreements 2>/dev/null | grep -qi "Proton.ProtonVPN"; then
  echo "Proton.ProtonVPN is already installed; nothing to do."
  exit 0
fi
