...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'Proton VPN' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'Proton VPN*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: Proton VPN'; exit 1 }
