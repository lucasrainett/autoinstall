...
if winget list --id Rustlang.Rustup -e --accept-source-agreements 2>/dev/null | grep -qi "Rustlang.Rustup"; then
  echo "Rustlang.Rustup is already installed; nothing to do."
  exit 0
fi
