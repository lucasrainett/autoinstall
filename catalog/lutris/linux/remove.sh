...
if flatpak info --user net.lutris.Lutris &>/dev/null; then
  flatpak uninstall --user net.lutris.Lutris -y
elif flatpak info --system net.lutris.Lutris &>/dev/null; then
  flatpak uninstall --system net.lutris.Lutris -y
fi
