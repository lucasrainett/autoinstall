...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'Sunshine' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'Sunshine*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: Sunshine'; exit 1 }
