...
if winget list --id LizardByte.Sunshine -e --accept-source-agreements 2>/dev/null | grep -qi "LizardByte.Sunshine"; then
  echo "LizardByte.Sunshine is already installed; nothing to do."
  exit 0
fi
