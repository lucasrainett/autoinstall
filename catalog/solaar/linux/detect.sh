...
flatpak list --columns=application 2>/dev/null | grep -qx "io.github.pwr_solaar.solaar" || exit 1
...
installed=$(flatpak info "$scope" --show-commit io.github.pwr_solaar.solaar 2>/dev/null) || exit 0
