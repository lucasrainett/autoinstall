...
echo "Xbox app is distributed through the Microsoft Store, which cannot be driven unattended."
echo "Opening its Store page — press Get/Install there to reinstall it."
powershell.exe -NoProfile -Command "Start-Process 'ms-windows-store://pdp/?ProductId=9MV0B5HZVK9Z'" 2>/dev/null || true
