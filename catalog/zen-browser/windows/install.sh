...
if winget list --id Zen-Team.Zen-Browser -e --accept-source-agreements 2>/dev/null | grep -qi "Zen-Team.Zen-Browser"; then
  echo "Zen-Team.Zen-Browser is already installed; nothing to do."
  exit 0
fi
