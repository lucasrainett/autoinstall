...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'Zen Browser' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'Zen Browser*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: Zen Browser'; exit 1 }
