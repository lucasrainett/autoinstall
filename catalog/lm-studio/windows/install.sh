...
if winget list --id ElementLabs.LMStudio -e --accept-source-agreements 2>/dev/null | grep -qi "ElementLabs.LMStudio"; then
  echo "ElementLabs.LMStudio is already installed; nothing to do."
  exit 0
fi
