...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'LM Studio' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'LM Studio*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: LM Studio'; exit 1 }
