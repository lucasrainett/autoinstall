...
if winget list --id Proton.ProtonMail -e --accept-source-agreements 2>/dev/null | grep -qi "Proton.ProtonMail"; then
  echo "Proton.ProtonMail is already installed; nothing to do."
  exit 0
fi
