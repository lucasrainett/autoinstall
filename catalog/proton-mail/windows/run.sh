...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'Proton Mail' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'Proton Mail*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: Proton Mail'; exit 1 }
