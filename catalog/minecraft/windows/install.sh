...
if winget list --id Mojang.MinecraftLauncher -e --accept-source-agreements 2>/dev/null | grep -qi "Mojang.MinecraftLauncher"; then
  echo "Mojang.MinecraftLauncher is already installed; nothing to do."
  exit 0
fi
