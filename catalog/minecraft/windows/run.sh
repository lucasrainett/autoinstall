...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'Minecraft' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'Minecraft*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: Minecraft'; exit 1 }
