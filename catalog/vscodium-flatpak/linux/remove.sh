...
if flatpak info --user com.vscodium.codium &>/dev/null; then
  flatpak uninstall --user com.vscodium.codium -y
elif flatpak info --system com.vscodium.codium &>/dev/null; then
  flatpak uninstall --system com.vscodium.codium -y
fi
