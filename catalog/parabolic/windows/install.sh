...
if winget list --id Nickvision.Parabolic -e --accept-source-agreements 2>/dev/null | grep -qi "Nickvision.Parabolic"; then
  echo "Nickvision.Parabolic is already installed; nothing to do."
  exit 0
fi
