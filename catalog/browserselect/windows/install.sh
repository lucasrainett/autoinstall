...
if winget list --id zumoshi.BrowserSelect -e --accept-source-agreements 2>/dev/null | grep -qi "zumoshi.BrowserSelect"; then
  echo "zumoshi.BrowserSelect is already installed; nothing to do."
  exit 0
fi
