...
if winget list --id angryziber.AngryIPScanner -e --accept-source-agreements 2>/dev/null | grep -qi "angryziber.AngryIPScanner"; then
  echo "angryziber.AngryIPScanner is already installed; nothing to do."
  exit 0
fi
