...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'Angry IP Scanner' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'Angry IP Scanner*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: Angry IP Scanner'; exit 1 }
