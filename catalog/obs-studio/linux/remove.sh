...
if flatpak info --user com.obsproject.Studio &>/dev/null; then
  flatpak uninstall --user com.obsproject.Studio -y
elif flatpak info --system com.obsproject.Studio &>/dev/null; then
  flatpak uninstall --system com.obsproject.Studio -y
fi
