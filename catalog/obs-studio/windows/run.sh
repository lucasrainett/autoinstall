...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'OBS Studio' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'OBS Studio*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: OBS Studio'; exit 1 }
