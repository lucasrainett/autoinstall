...
if winget list --id OBSProject.OBSStudio -e --accept-source-agreements 2>/dev/null | grep -qi "OBSProject.OBSStudio"; then
  echo "OBSProject.OBSStudio is already installed; nothing to do."
  exit 0
fi
