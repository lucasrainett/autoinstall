...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'MarkText' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'MarkText*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: MarkText'; exit 1 }
