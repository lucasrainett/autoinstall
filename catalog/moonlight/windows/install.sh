...
if winget list --id MoonlightGameStreamingProject.Moonlight -e --accept-source-agreements 2>/dev/null | grep -qi "MoonlightGameStreamingProject.Moonlight"; then
  echo "MoonlightGameStreamingProject.Moonlight is already installed; nothing to do."
  exit 0
fi
