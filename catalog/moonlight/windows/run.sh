...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'Moonlight' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'Moonlight*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: Moonlight'; exit 1 }
