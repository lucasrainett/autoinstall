...
powershell.exe -NoProfile -Command "
  \$app = Get-StartApps | Where-Object { \$_.Name -eq 'Signal' } | Select-Object -First 1
  if (-not \$app) { \$app = Get-StartApps | Where-Object { \$_.Name -like 'Signal*' } | Select-Object -First 1 }
  if (-not \$app) { Write-Error 'Not found in the Start menu: Signal'; exit 1 }
