...
if winget list --id OpenWhisperSystems.Signal -e --accept-source-agreements 2>/dev/null | grep -qi "OpenWhisperSystems.Signal"; then
  echo "OpenWhisperSystems.Signal is already installed; nothing to do."
  exit 0
fi
