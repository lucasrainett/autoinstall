...
if flatpak info --user com.ranfdev.DistroShelf &>/dev/null; then
  flatpak uninstall --user com.ranfdev.DistroShelf -y
elif flatpak info --system com.ranfdev.DistroShelf &>/dev/null; then
  flatpak uninstall --system com.ranfdev.DistroShelf -y
fi
