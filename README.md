...
**157 entries** across 13 categories — browsers, communication, dev-tools, media, gaming, creative,
productivity, security, privacy, system-utilities, AI, 3D printing and quality-of-life.
Platform coverage is 114 Linux, 78 macOS, 100 Windows; an entry simply has no folder for a platform
