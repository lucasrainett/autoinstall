...
curl -fsSL -o OrcaSlicer-Linux-flatpak_x86_64.flatpak "https://github.com/OrcaSlicer/OrcaSlicer/releases/download/${VERSION}/OrcaSlicer-Linux-flatpak_V${VERSION_NUM}_x86_64.flatpak"
